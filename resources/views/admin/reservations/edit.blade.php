                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.reservations.update', $reservation->id) }}">
                            ...
                            <div class="mt-1">
                                <select id="offer_id" name= "offer_id" class="form-multiselect block w-full mt-1">
                                    @foreach($offers as $offer)
                                        <option value="{{$offer->id}}" @selected($offer->id == $reservation->offer_id)>{{ $offer->name }} </option>
                                    @endforeach
                                </select>
                            </div>
                            @error('offer_id')
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="number" id="quantity" name="quantity" max="6.00" value="{{ $reservation->quantity }}"
